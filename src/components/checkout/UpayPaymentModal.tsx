  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-12 gap-2.5 sm:gap-3 mb-3 sm:mb-4">
          ...
          <div className="col-span-4 border border-gray-200 rounded-xl sm:rounded-2xl p-2 sm:p-3 flex items-center justify-center bg-white shadow-2xs">
            <div className="flex items-center justify-center h-9 sm:h-10 w-full">
              <svg viewBox="0 0 100 42" className="h-8 sm:h-9 w-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-[#00529b] rounded-2xl p-3.5 sm:p-5 text-white shadow-md mb-3 sm:mb-4">
          {/* Box Header */}
          ...
          <div className="mb-3.5">
            ...
            />
            {errorMessage && (
              <div className="mt-2.5 p-2 bg-blue-950/90 border border-yellow-300/60 rounded-xl text-yellow-100 text-xs font-bold text-center shadow-inner">
                {errorMessage}
              </div>
            )}
          </div>
          ...
          <div className="text-[11px] sm:text-[13px] font-medium leading-relaxed space-y-2 select-none">
            ...
            <div className="border-b border-blue-400/40 pb-2 flex flex-wrap items-center">
              <span className="font-bold mr-1.5">•</span>
        ...
        <button
          ...
          className="w-full bg-[#00529b] hover:bg-[#00427d] active:bg-[#003463] disabled:opacity-50 text-white font-black py-3.5 sm:py-4 px-6 rounded-xl sm:rounded-2xl text-base sm:text-lg shadow-md transition-all active:scale-[0.98] flex items-center justify-center tracking-wider select-none touch-manipulation cursor-pointer min-h-[50px] sm:min-h-[54px]"
        >
          {isSubmitting ? (
